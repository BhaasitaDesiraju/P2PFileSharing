...
public class FileManager {
   ...
   */
  public static synchronized Piece get(int index) {
    try {
      ...
      fis.read(content);
      fis.close();
      return new Piece(content, index);
   ...
   */
  public static synchronized void store(Piece piece) throws Exception {
