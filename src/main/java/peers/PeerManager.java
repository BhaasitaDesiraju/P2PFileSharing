...
//import main.java.files.FileManager;
//import main.java.log.WriteLog;
//import main.java.messages.Message;
//import main.java.messages.MessageType;
//import main.java.payloads.Have;
//
...
//  private HashMap<Integer, Peer> peers;  // Stores the peer process objects in a map
...
//
//  /**
//   * @param hostPeer the hostPeer to set
//   */
...
//
//  /**
//   * @param interestedPeers the interestedPeers to set
//   */
...
//
//  /**
//   * @param kNeighborPeers the kNeighborPeers to set
//   */
...
//
//  /**
//   * @param optimizedUnchokedPeer the optimizedUnchokedPeer to set
//   */
...
//      }
//
//      private void preferredNeighbors() throws InterruptedException {
...
//              indexI++;
//            }
//            writeLog.changeNeighbour(preferredPeers);
//            chokePeers();
//          }
//        }
...
//          optimisticallyUnchokedNeighbor(timeout);
//          while (!socketPort.isClosed()) {
//            optimisticallyUnchokedNeighbor(timeout);
//          }
//        }
...
//  }
//
//  private void optimisticallyUnchokedNeighbor(long timeout) throws InterruptedException {
//    synchronized (interestedPeers) {
...
//        unChokePeer(p);
//        writeLog.changeOptimisticallyUnchokedNeighbor(p.getPeerId());
//      }
//    }
//    Thread.sleep(timeout);
//  }
...
//    writeLog.unchokedByNeighbor(p.getPeerId());
//  }
//
//  /**
...
//        writeLog.chokedByNeighbor(temp.getPeerId());
//      }
//    }
//  }
//
...
//    Message have = new Have(MessageType.HAVE, "", index);
//
//    Iterator<Map.Entry<Integer, Peer>> itr = peers.entrySet().iterator();
//    while (itr.hasNext()) {
//      Map.Entry<Integer, Peer> entry = itr.next();
